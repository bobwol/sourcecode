	...
	<body >
		...
		<div id="contentContainer" class="hide">
			<div id="contentColumnWrapper">
				<div id="contentColumn" class="innertube roundedCorners whiteBackground wideColumn">
			...
			<div id="leftColumnWrapper">
				<div id="leftColumn" class="innertube roundedCorners ltGreyBackground showBorders" >
