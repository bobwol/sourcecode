...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'NalliTrack.com';
$config['webmaster_email'] = 'support@nallitrack.com';
...
$config['recaptcha_public_key'] = '6LfhJMsSAAAAAAqPvVuaC_h277F9GLZtThSsjKOG';
$config['recaptcha_private_key'] = '6LfhJMsSAAAAAJRZQpPpFKA4uqMrEkBB-961CqnX';
